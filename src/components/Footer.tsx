...
import logoImage from "../assets/led-logo.png";
import "./Footer.css";
    ...
    <footer className="footer">
        ...
        <div className="footer-content">
          <div className="footer-section footer-brand">
            ...
            <p className="footer-tagline">
              Illuminating your future with premium LED technology for
          ...
          <div className="footer-section">
            ...
            <Link to="/products#commercial">Commercial Lighting</Link>
            <Link to="/products#industrial">Industrial Lighting</Link>
            <Link to="/products#outdoor">Outdoor Lighting</Link>
            <Link to="/products#specialty">Specialty Solutions</Link>
          </div>
          ...
          <div className="footer-section footer-contact">
            ...
            <div className="contact-item">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                />
                <path
                  d="M10 17.5C13.3333 14.1667 16.6667 11.4052 16.6667 8.33333C16.6667 4.65143 13.6819 1.66667 10 1.66667C6.31811 1.66667 3.33334 4.65143 3.33334 8.33333C3.33334 11.4052 6.66667 14.1667 10 17.5Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                />
              </svg>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <p>
            © {currentYear} LED Lighting Solutions LLC. All rights reserved.
          </p>
